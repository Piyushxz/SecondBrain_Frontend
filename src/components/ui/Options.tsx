      ...
      <form className=" mt-6 ml-4 mr-4">
        ...
        <div className=" h-18 border border-white/30 rounded-lg flex  gap-2 p-2 cursor-pointer">
            <div id="tweet" onClick={()=>setContentModal('tweet')}
             className={` h-16 w-20 flex flex-col p-2 gap-1 border rounded-lg  ${contentModal === 'tweet' ? "border-blue-500 bg-blue-500/40" :" border-white/30 "}`}>
                <Twitter className="text-blue-500"/>
                <h1 className="text-white font-montserrat  text-sm">Tweet</h1>
            </div>
            <div id="youtube" onClick={()=>setContentModal('youtube')}
             className={` h-16 w-20 flex flex-col p-2 gap-1 border rounded-lg  ${contentModal === 'youtube' ? "border-red-500 bg-red-500/40" :" border-white/30 "}`}>
            ...
            <div id="document" onClick={()=>setContentModal('document')}
             className={` h-16 w-20 flex flex-col p-2 gap-1 border rounded-lg  ${contentModal === 'document' ? "border-yellow-500 bg-yellow-500/40" :" border-white/30 "}`}>
           ...
           className={` h-16 w-20 flex flex-col p-2 gap-1 border rounded-lg  ${contentModal === 'link' ? "border-purple-500 bg-purple-500/40" :" border-white/30 "}`}>

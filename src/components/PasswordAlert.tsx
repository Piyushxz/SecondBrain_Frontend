...
const PasswordAlertModal = () => {
  const showAlert = useRecoilValue(showAlertModal);

  return (
    <div className="w-screen h-24 top-0 left-0 fixed flex justify-center ">
      <div
        className={`flex p-4 mt-8 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 w-96 h-24 translate-all duration-500 ease-in-out ${

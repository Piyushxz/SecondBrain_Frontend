        ...
        <>
            <div className="mt-10">
                <ul>
                    ...
                    <div className={`flex  pl-8 mb-6 hover:bg-primaryColor2 p-4 ${contentType === "home"?" bg-primaryColor2 ":" "}`}>
                            <HomeIcon variant="lg"/>
                            <h1 className="pl-4 text-gray-300 text-lg font-montserrat font-xl">Home</h1>
                        </div>
                    </li> 
                    <li onClick={()=>setContentType("tweet")}>
                        <div  className={`flex  pl-8 mb-6 hover:bg-primaryColor2 p-4 ${contentType === "tweet"?" bg-primaryColor2 ":" "}`}>
                    ...
                    <div  className={`flex  pl-8 mb-6 hover:bg-primaryColor2 p-4 ${contentType === "youtube"?" bg-primaryColor2 ":" "}`}>
                    ...
                    <div  className={`flex  pl-8 mb-6 hover:bg-primaryColor2 p-4 ${contentType === "link"?" bg-primaryColor2 ":" "}`}>
                            <LinkIcon variant="lg"/>
